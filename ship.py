...
#         self.speed = 0 # Present speed
        ...
        self.torpedo_bay = None # Torpedo Bay List
...
#         magazine.location = None
    ...
    def attack(self, target, weapon):
        ...
        if weapon.force <= target.shield:
            ...
            # check casualties or other furtheer damage
